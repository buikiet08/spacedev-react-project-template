                    ...
                    <div className="row">
                        ...
                        <div className="col-6 col-sm">
                            ...
                            <ul className="list-unstyled mb-7 mb-sm-0">
                                ...
                                <li>
                                    <Link className="text-gray-300" to={PATH.Faq}>FAQs</Link>
                                </li>
                                <li>
                                    <a className="text-gray-300" data-toggle="modal" href="#modalSizeChart">Size Guide</a>
                                </li>
                                <li>
                                    <Link className="text-gray-300" to={PATH.Return}>Shipping &amp; Returns</Link>
                                </li>
                            </ul>
                        </div>
                        <div className="col-6 col-sm">
                        ...
                        <div className="col-6 col-sm">
                            ...
                            <ul className="list-unstyled mb-0">
                                <li>
                                    <Link className="text-gray-300" to={PATH.About}>Our Story</Link>
                                </li>
                                <li>
